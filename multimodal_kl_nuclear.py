...
# CHANGABLE: Select exponent for the norm of the singular vectors
# Can be set to 1, 2 or 'inf'
exponent = 2

# CHANGABLE: Select how strong the regularization should be.
# Should be about 0.1 with the 2d geometry
lam = 0.2

# Set up the nuclear norm.
g_lnuclear = lam * odl.solvers.NuclearNorm(grad_n.range,
